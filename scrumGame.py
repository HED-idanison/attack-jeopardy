...
question7 = "Who is responsible to measure the Project’s performance?"
...
# while WantToQuit !="q":
#     print("Welcome to Attack Jeparody. All the questions are based on scrum")
#     print("You are player 1")
#     print("Please select whether you would like to remove points from someone else, n or add points to yourself")
#     action = input("Select 'b' to benefit yourself or 'a' to attack someone else")
#     print(action)
#     wager = input("Please make a wager")
#     print(wager)


#     WantToQuit = input("Press enter to go onto next question or press 'q' to quit.")
# print("You have left the game-loop")
